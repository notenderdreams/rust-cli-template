...
<#
.SYNOPSIS
    Installs {{project-name}} from GitHub Releases on Windows.
.EXAMPLE
    irm https://raw.githubusercontent.com/notenderdreams/{{project-name}}/main/installers/install.ps1 | iex
#>
...
$Repo       = "notenderdreams/{{project-name}}"
$Binary     = "{{project-name}}"
$InstallDir = Join-Path $env:USERPROFILE ".{{project-name}}\bin"
...
function Install-App {
    ...
    Write-Info "Restart your terminal, then run '{{project-name}} --help' to get started."
}
